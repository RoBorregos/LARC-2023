...
void vlxSetup(){
    ...
    sensorList_t sensors[] = {
        {&vlx[0], &Wire2, 0x30, Constants::kWarehouseVLXxshutUpper, 0, Adafruit_VL53L0X::VL53L0X_SENSE_HIGH_ACCURACY, 0, 0},
        {&vlx[1], &Wire2, 0x31, Constants::kWarehouseVLXxshutMid, 0, Adafruit_VL53L0X::VL53L0X_SENSE_HIGH_ACCURACY, 0, 0},
        {&vlx[2], &Wire1, 0x32, Constants::kWarehouseVLXxshutLower, 0, Adafruit_VL53L0X::VL53L0X_SENSE_HIGH_ACCURACY, 0, 0},
        {&vlx[3], &Wire1, 0x33, Constants::kElevatorVLXxshut, 0, Adafruit_VL53L0X::VL53L0X_SENSE_HIGH_ACCURACY, 0, 0}
    };
