...
class Yolov7Publisher:
    def __init__(self, img_topic: str, weights: str, conf_thresh: float = 0.5,
        ...
        self.pubInfo = rospy.Publisher(pub_topic + "/info", objectDetectionArray, queue_size=5)
    ...
    def process_img_msg(self, img_msg: Image):
        ...
        # publishing
        detection_msg = create_detection_msg(img_msg, detections,self.class_labels)
        #self.detection_publisher.publish(detection_msg)
        self.pubInfo.publish(detection_msg)
