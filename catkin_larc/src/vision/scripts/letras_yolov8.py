...
class letras_yolov8:
        def __init__(self):
            ...
            rospy.logdebug("letras_yolov8 initialized")

            self.pubdata = rospy.Publisher('/vision/letter_detect', objectDetectionArray, queue_size=5)
        ...
        def lector(self):
            ...
            try:
                ...
                rospy.logerr("Failed to process frame")
                rospy.logerr(e)
